  ...
  return (
    <div className="job_contain">
      <div className="job_store">
        ...
        <button onClick={prevPage} title='Go to previous page' disabled={page === 0}>
        <i class="fa-solid fa-reply"></i>
          </button>
          <span>{page}</span>
          <button onClick={nextPage} title='Go to next page' disabled={page === 15469}><i class="fa-solid fa-share"></i></button>
        </div>
      </div>
    </div>
  );
